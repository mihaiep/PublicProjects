...
from Nets.MTCNN.Original.exceptions import InvalidImage
from Nets.MTCNN.Original.factory import NetworkFactory
...
class MTCNN(object):
    ...
    def __init__(self, weights_file: str = None, min_face_size: int = 20, steps_threshold: list = None,
        ...
        if weights_file is None:
            weights_file = pkg_resources.resource_stream('Nets.MTCNN.Original.mtcnn', 'data/mtcnn_weights.npy')
